...
export const Profile: React.FC = () => {
  ...
  const filteredUsers = allUsers.filter(u => 
    ...
    (u.hierarchy || '').toLowerCase().includes(userSearchTerm.toLowerCase())
  );
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2 mt-1 flex-wrap">
                                                    <span className="text-[9px] bg-indigo-950 border border-indigo-500/20 text-indigo-400 font-black px-1.5 py-0.5 rounded uppercase tracking-wider">{u.hierarchy || 'Personal Administrativo'}</span>
